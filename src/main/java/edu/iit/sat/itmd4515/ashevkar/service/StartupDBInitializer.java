...
public class StartupDBInitializer {
    ...
    private void postConstruct(){
        ...
        Doctor d1 = new Doctor("Nitin", "Neurology", 7324732647L, LocalDate.of(2024,04,1));
        //set is used for 1:M/M:1
        d1.setHospital(h1);
        Doctor d2 = new Doctor("Lata", "Orthopedics", 9422314917L, LocalDate.of(2024,05,20));
        d2.setHospital(h2);
        Doctor d3 = new Doctor("Sunil", "Urology", 9420697107L, LocalDate.of(2024,05,10));
        d3.setHospital(h2);
        Doctor d4 = new Doctor("Priya", "Cardiology", 7709353388L, LocalDate.of(2024, 6, 11));
        d4.setHospital(h1);
